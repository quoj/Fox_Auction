        ...
        <div>
            ...
            <section className="about-mission" style={{ padding: '50px 0' }}>
                <Container>
                    <Row>
                        <Col md={6}>
                            <Image src="https://via.placeholder.com/500" fluid alt="Our Mission" />
                        </Col>
                        <Col md={6}>
                            <h2 style={{ fontSize: '32px', fontWeight: 'bold' }}>Our Mission</h2>
                            <p style={{ fontSize: '18px', color: '#555' }}>
                                We believe in the power of secondhand shopping, not just as a way to save money, but as a more sustainable way of living. By reselling and buying pre-loved items, we’re helping to reduce waste and make the world a better place for future generations.
                            </p>
            ...
            <section className="about-team" style={{ backgroundColor: '#f8f8f8', padding: '50px 0' }}>
                <Container>
                    <Row className="text-center">
                        <Col md={12}>
                            ...
                            <p style={{ fontSize: '18px', color: '#555', maxWidth: '800px', margin: '20px auto' }}>
                                Our team is composed of talented individuals from diverse backgrounds who are all passionate about creating a better shopping experience.
                            </p>
                        </Col>
                    </Row>
                    ...
                    <Carousel indicators={false} interval={null}>
                        <Carousel.Item>
                            <Row className="text-center">
                                <Col md={4}>
                                    <Image src="https://via.placeholder.com/300" roundedCircle fluid alt="Team Member" />
                ...
                <Row>
                    <Col md={6} className="banner-1 hidden">
                        <a href="">
                            <Image src="https://via.placeholder.com/300" alt=""  fluid />
                        </a>
                    </Col>
                    <Col md={6} className="banner-2-3 hidden d-flex flex-column">
                    <a href="">
                        <Image id="banner-2" src="https://via.placeholder.com/300" alt="" fluid />
                    </a>
                    <a href="">
                        <Image src="https://via.placeholder.com/300" alt="" fluid style={{ marginTop: '10px' }} />
                    </a>
                    </Col>
