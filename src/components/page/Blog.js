                ...
                <Row>
                    <Col lg={9}>
                        ...
                        <div className="blog-news" style={{ marginBottom: '40px' }}>
                            <a href="run">
                                <Image src="Shoes/IMAGES/Blog_Picture/blog1.webp" alt="" width="100%" style={{ borderRadius: '10px' }} />
                            </a>
                        ...
                        <div className="blog-news" style={{ marginBottom: '40px' }}>
                            <a href="basketball.html">
                                <Image src="Shoes/IMAGES/Blog_Picture/blog2.webp" alt="" width="100%" style={{ borderRadius: '10px' }} />
                            </a>
                            <div className="blog-content" style={{ paddingTop: '20px' }}>
                                <h4 style={{ color: '#ff4081', fontWeight: 'bold' }}>NEWS</h4>
                         ...
                         <div className="blog-news" style={{ marginBottom: '40px' }}>
                            <a href="antique-jewelry.html">
                                <Image src="Antiques/IMAGES/Blog_Picture/antique3.webp" alt="" width="100%" style={{ borderRadius: '10px' }} />
                            </a>
                            <div className="blog-content" style={{ paddingTop: '20px' }}>
                                <h4 style={{ color: '#ff4081', fontWeight: 'bold' }}>NEWS</h4>
                         ...
                         <div className="blog-news" style={{ marginBottom: '40px' }}>
                            <a href="antique-glass.html">
                                <Image src="Antiques/IMAGES/Blog_Picture/antique4.webp" alt="" width="100%" style={{ borderRadius: '10px' }} />
                            </a>
                            <div className="blog-content" style={{ paddingTop: '20px' }}>
                                <h4 style={{ color: '#ff4081', fontWeight: 'bold' }}>NEWS</h4>
                        ...
                        <div className="blog-news" style={{ marginBottom: '40px' }}>
                            <a href="antique-collectibles.html">
                                <Image src="Antiques/IMAGES/Blog_Picture/antique5.webp" alt="" width="100%" style={{ borderRadius: '10px' }} />
                            </a>
                            <div className="blog-content" style={{ paddingTop: '20px' }}>
                                <h4 style={{ color: '#ff4081', fontWeight: 'bold' }}>NEWS</h4>
